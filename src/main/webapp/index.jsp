...
<body onload="load()">
				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header d-flex align-items-center">
							<h3 class="h4">Researchers</h3>
						</div>
						<div class="card-body">
							<form class="form-horizontal">
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">researchers
										id</label>
									<div class="col-sm-9">
										<input id="researchers_id" type="text"
											placeholder="researchers id"
								...
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">qualifications</label>
									<div class="col-sm-9">
								...
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">contact
										number</label>
									<div class="col-sm-9">
								...
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">interested
										research areas</label>
									<div class="col-sm-9">
										<input id="interested_research_areas" type="text"
											placeholder="interested research areas"
											class="form-control form-control-warning">
									</div>
								</div>
								<div class="form-group row">
								...
								<table class="table table-hover" id="table">
									<thead>
										<tr>
											...
											<th>interested research areas</th>
										</tr>
									</thead>
								</table>
							</div>
	...
	<script src="ajax/Researchers.js"></script>
